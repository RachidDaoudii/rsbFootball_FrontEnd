...
import { useCategoriesQuery ,useAddcategoryMutation,useDeletecategoryMutation,useUpdatecategoryMutation } from "@/redux/service/marketplace/marketplaceApi";
...
useEffect(()=>{
  if(isSuccessCategory){
      return toast.success("Category send successfully");
  }
  if(isErrorCategory){
    return toast.error("error");
  }
  if(isSuccessCategoryUpdate){
    return toast.success("Category updated successfully");
  }
  if(isSuccessCategoryDelete){
    return toast.success("Category deleted successfully");
  }

},[isErrorCategory,isSuccessCategory,isSuccessCategoryDelete,isSuccessCategoryUpdate,refetch])
